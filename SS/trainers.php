	...
	$i = $_GET['i'];
		...
		while($row = mysql_fetch_array($res))
		{
        	...
        	<div class="gallery_item">
                <img src="<?php echo "./t_images/".$row['image']; ?>" alt="" title="" border="0" />
                <span><a href="<?php echo "./t_images/".$row['image']; ?>" rel="prettyPhoto[gallery]" title="<?php echo $row['dis']; ?>"><img src="images/photo.png" alt="" title="" /></a></span>
                    <div class="gallery_caption">
                    <h3><?php echo $row['t_name']; ?></h3>
                    <h3><?php echo $row['t_post']; ?></h3>
