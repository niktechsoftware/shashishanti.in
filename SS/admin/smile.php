...
<div class="main_page">
    ...
    <div class="page_body">
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SS Dental Smile Gallery Entry
        <hr />        
        <table>
        	<tr>
            	<td valign="top">
                	<form method="post" action="smile_db.php" enctype="multipart/form-data" >
                        <table align="center">
                            <tr>
                                ...
                                <td style="background:none;">
                                	<select name="sec" class="text1" style="height:35px; width:220px; padding-top:3px;" >
                                        ...
                                        <option value="2">10th Year Celebration</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td style="background:none; text-align:left;"><label>Image Title</label></td>
                                <td style="background:none;"><input type="text" class="text1" name="title" required /></td>
                            </tr>
                            <tr>
                ...
                <td valign="top">
                	<table>
                        ...
                        <?php
							include_once"db.php";
							$detail = "select * from smile";
							$q = mysql_query($detail);
							while($row = mysql_fetch_array($q))
							{
						?>
                        <form action="smile_edit.php" method="post">
                        <tr>
                            ...
                            <td><a href="smile_delete.php?sno=<?php echo $row['sno']; ?>">Delete</a></td>
                        </tr>
                        </form>
                        <?php	
							}
