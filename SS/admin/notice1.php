...
<div class="main_page">
	<div class="page_header">
    	<center><h1>Shashi Shanti Dental and Oral Care Admin Panel</h1></center>
    </div>
    ...
    <div class="page_body">
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dental Notice Board Entry
        <hr />        
        <table>
        	<tr>
            	<td>
                	<form method="post" action="notice_db1.php" >
                        <table align="center">
                            <tr>
                ...
                <td valign="top">
                	<table>
                        ...
                        <?php
							include_once"db.php";
							$detail = "select * from notice1";
							$q = mysql_query($detail);
							while($row = mysql_fetch_array($q))
							{
						?>
                        <form action="notice_edit1.php" method="post">
                        <tr>
                            ...
                            <td><a href="notice_delete1.php?sno=<?php echo $row['sno']; ?>">Delete</a></td>
                        </tr>
                        </form>
                        <?php	
							}
