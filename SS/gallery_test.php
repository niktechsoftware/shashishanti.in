...
<?php
	include_once"db.php";
			...
			$q = "select * from smile where cat='1'";
        	...
        	<div class="gallery_item">
                <img src="1/<?php echo $row['image']; ?>" alt="" title="" border="0" />
                <span><a href="1/<?php echo $row['image']; ?>" rel="prettyPhoto[gallery]" title="<?php echo $row['dis']; ?>"><img src="images/photo.png" alt="" title="" /></a></span>
