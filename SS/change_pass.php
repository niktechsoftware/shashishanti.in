   ...
   <div class="content">
   		...
   		<div class="left23 left_content">
                ...
                <h2>Change Your Password</h2>  
                    ...
                    <form id="form1" method="post" action="change_pass_db.php">
                    <div class="form_top">
                        <div class="form_row" style="padding:15px;">
                        <input type="password" class="form_input" name="old_pass" placeholder="Old Password"/>
                        <input type="hidden" name="user_name" value="<?php echo $test; ?>"/>
                        </div>
                        <div class="form_row" style="padding:15px;">
                        <input type="password" class="form_input" name="new_pass" placeholder="New Password"/>
                        </div>                        
                        <div class="form_row" style="padding:15px;">
                        <input type="password" class="form_input" name="new_pass1" placeholder="Re-Type Password"/>
                        </div>
                        <?php
							$i = $_GET['i'];
							if($i == 1)
						...
						?>
                        	<div class="form_row" style="padding:15px;">
                            	<font color="#FF0000">Re-Password not matched...</font>
                            </div>
                        <?php
							}
							if($i == 2)
						...
						?>
                        	<div class="form_row" style="padding:15px;">
                            	<font color="#FF0000">Wrong Old-Password. Please Enter Correct Password.</font>
                            </div>
                        <?php
							}
							if($i == 3)
						...
						?>
                        	<div class="form_row" style="padding:15px;">
                            	<font color="#006600">Password Successfuly updated.</font>
                            </div>
                        <?php
							}
						?>
                    ...
                    <div class="form_bottom" style="text-align:left;">
                        <input type="submit" class="form_submit" style="float:left; margin-left:22px;" value="Click to Change Password" />
                    </div>           
                    </form>
                </div>
        </div>
